...
cask "shopware-cli" do
  ...
  on_macos do
    on_intel do
      sha256 "64bc966ce900fcc2a4c2e63d11308ee23da3c25513969cd5264b4f7cae4ac2ac"
      url "https://github.com/shopware/shopware-cli/releases/download/#{version}/shopware-cli_Darwin_x86_64.tar.gz"
    end
    on_arm do
      sha256 "650bc8824c6f27632e02d78634cc4ba0b9e4982fa0f24d5e079c0756bb16e28d"
  ...
  on_linux do
    on_intel do
      sha256 "630bcff49df6a75020f5528d7f4cc166c95811577d9cd473f0a2e98103bf4a91"
      url "https://github.com/shopware/shopware-cli/releases/download/#{version}/shopware-cli_Linux_x86_64.tar.gz"
    end
    on_arm do
      sha256 "4ff7e026d49f5e7b9e3930c3cc2f778f26864c4de4fc2075d03ef84af992f545"
